package scripting.sscript.macro;
...
@:access(scripting.sscript.hscriptBase.Tools)
class Macro {
	...
	public static final allClassesAvailable:Map<String, Class<Dynamic>> = scripting.sscript.hscriptBase.Tools.names.copy();
	#end
